...
| **세션** | 접힘/펼침 운동 카드, 종목별 자극 팁, 머신 세팅 메모, 롱프레스 가속 스테퍼, 세트 체크 → 휴식 타이머 자동 시작, 워밍업 세트, 감각 점수, 보상작용 체크리스트, 수행 순서 자동 기록 |
...
erDiagram
  ...
  ExerciseNote }o--|| Exercise : "recordKey (머신 세팅)"
```
...
- 테스트: Vitest (알고리즘 단위 테스트 235개, CI에서 배포 전 실행)
